...
- (id)initWithDefault:(UIImage*)star highlighted:(UIImage*)highlightedStar position:(int)index allowFractions:(BOOL)fractions Scale:(double)scale {
	...
	if (self) {
        ...
        CGRect frame = CGRectMake((star.size.width*index*scale), 0, star.size.width*scale, star.size.height*scale
                                  /*+kEdgeInsetBottom*/);
        self.frame = frame;
